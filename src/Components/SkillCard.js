      ...
      case '#skill':
        return (
          <>
            <Card.Text>
            <ul>
              <li>Backend Development using SpringBoot</li>
              <li>Frontend Development using React JS</li>
              <li>Proficient in HTML, CSS, Javascript, SpringBoot, Java, MySQL</li>
              <li>Similar with Python, C, C++</li>
              <li>Software & Tools: Git, GitHub, Postman, Spring Tool Suite, MySQL Workbench, Eclipse IDE, VS Code</li>
            </ul>
            </Card.Text>
          </>
        );
          ...
          <>
            <div className='coding-platform'>
              <Card.Text>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="leetcode" height="40" width="40">
              ...
              <Link to="https://www.codechef.com/users/shashank_r10" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" style={{ margin: '0 1em' }} viewBox="0 0 24 24">
              ...
              <Link to="https://codeforces.com/profile/shashankp10" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="code-forces" height="40" width="40"style={{margin: '0 1em' }}>
